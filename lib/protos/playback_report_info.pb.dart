...
class PlaybackReportInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PlaybackReportInfo', createEmptyInstance: create)
  ...
  PlaybackReportInfo._() : super();
  factory PlaybackReportInfo({
    $core.bool? ok,
  ...
  factory PlaybackReportInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PlaybackReportInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PlaybackReportInfo clone() => PlaybackReportInfo()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PlaybackReportInfo copyWith(void Function(PlaybackReportInfo) updates) => super.copyWith((message) => updates(message as PlaybackReportInfo)) as PlaybackReportInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PlaybackReportInfo create() => PlaybackReportInfo._();
  PlaybackReportInfo createEmptyInstance() => create();
  static $pb.PbList<PlaybackReportInfo> createRepeated() => $pb.PbList<PlaybackReportInfo>();
  @$core.pragma('dart2js:noInline')
  static PlaybackReportInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PlaybackReportInfo>(create);
  static PlaybackReportInfo? _defaultInstance;
