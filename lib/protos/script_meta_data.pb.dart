...
class ScriptMetaData extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  ScriptMetaData copyWith(void Function(ScriptMetaData) updates) => super.copyWith((message) => updates(message as ScriptMetaData)) as ScriptMetaData; // ignore: deprecated_member_use
