...
class RecordPacket extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  RecordPacket copyWith(void Function(RecordPacket) updates) => super.copyWith((message) => updates(message as RecordPacket)) as RecordPacket; // ignore: deprecated_member_use
...
class PointerRecord extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PointerRecord copyWith(void Function(PointerRecord) updates) => super.copyWith((message) => updates(message as PointerRecord)) as PointerRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
