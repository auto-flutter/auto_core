...
class BadRequestResponse extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  BadRequestResponse copyWith(void Function(BadRequestResponse) updates) => super.copyWith((message) => updates(message as BadRequestResponse)) as BadRequestResponse; // ignore: deprecated_member_use
